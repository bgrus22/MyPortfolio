...
```{r}
WBdta <- read_csv('Final/CleanData/WB_clean.csv')

LCOEdta <-  read_csv('Final/CleanData/LCOE.csv')

globalplants <- read_csv('Final/CleanData/globalplants1.csv')

CCoEdta <-  read_csv('Final/CleanData/capital-costs-of-electricity.csv')

Materials <- read_csv('Final/CleanData/Plant_Materials.csv')

Matprice <- read_csv('Final/CleanData/Material_prices.csv')
```
